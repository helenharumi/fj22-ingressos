...
public class GerenciadorDeSessao {
	...
	private boolean horarioIsConflitante(Sessao sessaoExitente, Sessao sessaoNova) {
		
		LocalDateTime inicioSessaoExistente = getInicioSessaoComDiaDeHoje(sessaoExitente);
		LocalDateTime terminoSessaoExistente = getTerminoSessaoComDiaDeHoje(sessaoExitente);
